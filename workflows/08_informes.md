...
| Informe individual por establecimiento (obl. 15) | Por cliente | Una vez, al cierre de activación | `clientes/<c>/INFORME.md` | `entregables/informes/informe-<cliente-slug>-<YYYY-MM-DD>.pdf` |
...
2. Poblar `clientes/<c>/INFORME.md` desde: `CARACTERIZACION.md`, `PROGRESS.md`, evidencias en `evidencias/<c>/`, métricas del dashboard.
...
6. Cerrar `C-08` en `TASKS.md` del cliente.
