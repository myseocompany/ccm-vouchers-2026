...
1. Crear tenant en AriCRM con nombre y slug del cliente. Registrar `tenant_id` en `clientes/<c>/CLIENTE.md`.
...
7. Guardar evidencia (capturas del panel + IDs de tenant/usuarios) en `evidencias/<c>/config-tenant/`.
8. Actualizar `PROGRESS.md` y cerrar `C-02` + `C-03` en `TASKS.md` del cliente.
